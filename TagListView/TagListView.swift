...
open class TagListView: UIView {
    ...
    @IBInspectable open dynamic var cornerRadius_: CGFloat { get { return cornerRadius } set { cornerRadius = newValue } }
    ...
    @IBInspectable open dynamic var borderWidth_: CGFloat { get { return borderWidth } set { borderWidth = newValue } }
    ...
    @IBInspectable open dynamic var borderColor_: UIColor? { get { return borderColor } set { borderColor = newValue } }
    ...
    @IBInspectable open dynamic var selectedBorderColor_: UIColor? { get { return selectedBorderColor } set { selectedBorderColor = newValue } }
